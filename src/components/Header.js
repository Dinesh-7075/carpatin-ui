    ...
    <header className="fixed z-0 w-[100%] top-0 left-0">
      <div className="mx-1 my-2 flex p-3 min-h-16 shadow-lg justify-between pr-32 items-center">
        <div className="flex justify-between">
          <div
            className={"flex items-center lg:mr-[500%] md:mr-[200%] mr-[50%] "}
          >
            <a href="/">
              <svg
                fill="none"
          ...
          <div
            className="hover:bg-slate-400 rounded-lg w-18 p-2 lg:mr-[5px] md:mr-[5px] mr-[10px] font-bold cursor-pointer "
          ...
          <div
            onClick={handleClick}
            className={
              "flex sm:ml-12 md:mx-10 lg:hidden sm:flex items-center cursor-pointer rounded-lg p-2 " +
              (myContext.isSideBar ? " " : " bg-slate-400 ") +
              (myContext.isHoveredOnContent ? "bg-white" : "")
            }
            title="Menu"
          >
            <MenuIcon />
