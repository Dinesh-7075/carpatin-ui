...
const Header = () => {
  ...
  return (
    <div className="mx-1 my-2 flex p-3 shadow-lg h-16 fixed w-[100%] z-[1100] top-0 left-0 justify-between pr-32">
      <div className="flex items-center ">
        ...
        <div onClick={handleClick} className="flex sm:ml-12 md:mx-10 lg:hidden sm:flex items-center cursor-pointer"  title="Menu">
        <MenuIcon  />
        </div>
    </div>
  );
