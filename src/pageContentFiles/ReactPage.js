const ReactPage = [
 ...
 \n ## Vercel Deployment
  ...
  },
  {
    ...
    \`\`\` \n\n
    The customerApi is a singleton class instance that simply responds with a Promise. You can add as \n many requests  methods as you need, test request structure or even use as\n middleware between UI and server request to process your input and output data
    <br/>
    <br/>
   \n ## Example with Fetch
   \`\`\`JavaScript
    ...
    \n\n By using Axios you are able to integrate Axios Mock Adapter to simulate real server calls. To archive that, \nyou have to create an Axios instance and use it whenever you make a request call. Now you can extend \nyour instance and add Axios Mock Adapter to listen for requests and return custom data.
    <br/>
    <br/>
    <br/>
    ## Adding request interceptors
    \n\n It takes ony a few seconds to add a new http request listener. The interceptor \nhas a similar format to Express JS, for example:
    \n\n \`\`\`JavaScript
    import axios from 'axios';  // You need to install it
